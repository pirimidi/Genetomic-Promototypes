...
# output in a textfile with the randomly shuffled set of 
# gene sequence using the sliding window method in Perl.
#
# Input: gene_name, config_file.
#
# Output: a text file with a set of permuted gene 
# sequences.
#------------------------------------------------------------
...
if (@ARGV<2) {
  die "\n--> Error: not correct input!\n--> Usage: perl permutate.pl gene config_file\n\n";
}
...
print "\n--> Process started - permutate.pl";		     # Process start.
