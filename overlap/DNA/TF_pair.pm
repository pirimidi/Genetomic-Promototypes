...
sub new {
  ...
  $self->{hg_comp_value};				# Hyper-geometric comparision value of TF pair.
  $self->{distinct_proms};				# No. of distinct promoters pair occurs in.
  $self->{overlap_proms};				# No. of distinct promoters overlap occurs in.
  $self->{overlap_num};					# No. of times overlap occurs.
  $self->{overlap_ratio};				# Overlap/distinct promoters.
